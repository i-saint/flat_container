...
template <class Key, size_t BufferCapacity, class Compare = std::less<>>
using fixed_set = basic_set<Key, Compare, fixed_vector<Key, BufferCapacity>>;

template <class Key, size_t BufferCapacity, class Compare = std::less<>, class Allocator = std::allocator<Key>>
using small_set = basic_set<Key, Compare, small_vector<Key, BufferCapacity, Allocator>>;
